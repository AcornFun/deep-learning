...
for i, (sentence, label) in enumerate(train_data[:5]):
    print(f"Sample {i + 1}:")
...
print("\nBatch Data:")
batch_size = 4
data_generator = WeiBoDataGenerator(train_data, tokenizer, batch_size=batch_size)
for batch_token_ids, batch_labels in data_generator:
    print("Batch Token IDs (Padded):")
